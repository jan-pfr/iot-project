...
function sliderValue(){
    document.getElementById('lbl0').innerHTML = document.getElementById('slider0').value;
    document.getElementById('lbl1').innerHTML = document.getElementById('slider1').value;
    document.getElementById('lbl2').innerHTML = document.getElementById('slider2').value;
    document.getElementById('lbl3').innerHTML = document.getElementById('slider3').value;
}
...
//Temperature Kitchen//////////////////////////////////////////////////////////////////////////
    ...
    document.getElementById('btnUpKitchen').addEventListener('click', function(){

        tempKitchen= tempKitchen+1;
        document.getElementById('tempKitchen').innerHTML= tempKitchen+'°C';
        
    });
    document.getElementById('btnDownKitchen').addEventListener('click', function(){
